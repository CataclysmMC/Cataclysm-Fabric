...
import org.cataclysm.common.registry.item.tool.CataclysmToolMaterial;
import org.jetbrains.annotations.NotNull;

import java.util.Random;

public abstract class TwistedTool extends ToolItem implements Modeled {
    public static final ToolMaterial TOOL_MATERIAL = CataclysmToolMaterial.TWISTED;

    public TwistedTool(Settings settings) {
