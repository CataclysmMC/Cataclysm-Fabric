...
public class ArcaneTridentItem extends TridentItem {
    public ArcaneTridentItem(Item.Settings settings) {
        super(settings.component(DataComponentTypes.TOOL, TridentItem.createToolComponent()).attributeModifiers(TridentItem.createAttributeModifiers()));
    }
