package org.cataclysm.common.registry.entity;
...
import org.cataclysm.common.registry.entity.projectile.ArcaneTridentEntity;

public final class CataclysmEntityTypes {
    private static final Registry<EntityType<?>> REGISTRY = Registries.ENTITY_TYPE;
    ...
    public static Registry<EntityType<?>> initialize() {
        return REGISTRY;
    }
