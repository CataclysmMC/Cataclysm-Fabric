...
import org.cataclysm.global.registry.item.custom.misc.RelicItem;
import org.cataclysm.global.registry.item.custom.tool.*;
import org.cataclysm.global.registry.item.custom.misc.paragon.ParagonBlessingItem;
import org.cataclysm.global.registry.item.custom.misc.paragon.ParagonPearlItem;
...
public final class CataclysmItems {
    public static final Item TWISTED_CHALICE = registerItem("twisted_chalice", new RelicItem());
    public static final Item TWISTED_SWORD = registerItem("twisted_sword", new CataclysmSword(CataclysmMaterials.TWISTED));
    public static final Item TWISTED_AXE = registerItem("twisted_axe", new CataclysmAxe(CataclysmMaterials.TWISTED));
    public static final Item TWISTED_PICKAXE = registerItem("twisted_pickaxe", new CataclysmPickaxe(CataclysmMaterials.TWISTED));
    public static final Item TWISTED_SHOVEL = registerItem("twisted_shovel", new CataclysmShovel(CataclysmMaterials.TWISTED));
    public static final Item TWISTED_HOE = registerItem("twisted_hoe", new CataclysmHoe(CataclysmMaterials.TWISTED));
