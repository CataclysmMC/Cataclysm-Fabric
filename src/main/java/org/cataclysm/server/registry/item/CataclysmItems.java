...
import org.cataclysm.server.registry.item.custom.arcane.ArcaneShieldItem;
import org.cataclysm.server.registry.item.custom.arcane.ArcaneTridentItem;
import org.cataclysm.server.registry.item.custom.calamity.CalamityArmorItem;
import org.cataclysm.server.registry.item.custom.misc.LemegetonItem;
import org.cataclysm.server.registry.item.custom.misc.relic.TwistedChaliceItem;
import org.cataclysm.server.registry.item.custom.paragon.ParagonBlessingItem;
import org.cataclysm.server.registry.item.custom.paragon.ParagonPearlItem;
import org.cataclysm.server.registry.item.custom.paragon.ParagonTotem;
import org.cataclysm.server.registry.item.custom.twisted.*;
